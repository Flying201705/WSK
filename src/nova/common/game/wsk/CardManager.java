...
import nova.common.game.wsk.util.TestUtil;
...
public class CardManager {
	...
	private void getRandomCardListForDebug() {
		if (2 == TestUtil.Debug_Type) {
			fillCardListForDebug(TestUtil.CARD_ELEMENTS_DEBUG_2);
		} else if (21 == TestUtil.Debug_Type) {
			fillCardListForDebug(TestUtil.CARD_ELEMENTS_DEBUG_21);
		} else if (4 == TestUtil.Debug_Type) {
			fillCardListForDebug(TestUtil.CARD_ELEMENTS_DEBUG_4);
		} else {
			fillCardListForDebug(TestUtil.CARD_ELEMENTS_DEBUG_1);
		}
	}
